...
// Environment variables - will be manually set in this test file
...
const createToken = (): { token: string; expiresAt: number } => {
...
const testAnalyticsAccess = async (): Promise<void> => {
  if (!PROPERTY_ID) {
