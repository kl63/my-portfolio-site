  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        {/* Modern Contact Form with Zapier Integration */}
        <ContactForm 
          title="Send Me a Message"
          subtitle="I&apos;d love to hear from you. I&apos;ll respond as soon as possible."
        />
        ...
        <div className="space-y-8">
          ...
          >
            ...
            <div>
              ...
              <p className="text-muted-foreground">lin.kevin.1923@gmail.com</p>
            </div>
          </motion.div>
          ...
          <div className="pt-8 border-t border-border mt-8">
            ...
            <div className="flex space-x-4">
              ...
              <a 
                href="https://linkedin.com/in/linkevin19" 
                target="_blank" 
                rel="noreferrer"
                className="bg-muted hover:bg-muted/80 p-3 rounded-full transition-colors"
              >
